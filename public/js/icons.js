const ICONS = {
	...
	model: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.5 20 8v8l-8 4.5L4 16V8z"/><path d="M12 12.5 20 8"/><path d="M12 12.5 4 8"/><path d="M12 12.5v8"/></svg>',
	part: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 7.5 12 4l7 3.5v8.8l-7 3.7-7-3.7z"/><path d="M5 7.5 12 11l7-3.5"/><path d="M12 11v9"/></svg>',
	gui: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16v12H4z"/><path d="M8 21h8"/><path d="M12 17v4"/></svg>',
	remote: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 8a7 7 0 0 1 10 0"/><path d="M9.5 11a3.5 3.5 0 0 1 5 0"/><path d="M12 14h.01"/><path d="M5 19h14"/></svg>',
	value: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 5h12v14H6z"/><path d="M9 9h6"/><path d="M9 13h4"/></svg>',
	sound: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 10v4h4l5 4V6L9 10z"/><path d="M17 9a4 4 0 0 1 0 6"/></svg>',
	light: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9 18h6"/><path d="M10 21h4"/><path d="M8 10a4 4 0 1 1 8 0c0 2-1.2 3-2 4H10c-.8-1-2-2-2-4z"/></svg>',
