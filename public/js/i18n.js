...
export const TRANSLATIONS = {
	en: {
		...
		entryHeroTitle: "Cloud Workspace",
		entryHeroBody: "Connect your private session, open your project tree, and edit scripts in a clean professional workspace.",
		...
		entryConnectBody: "Paste your Session ID and Hidden Secret to unlock your private workspace.",
		...
		entryCtaBody: "Open Learn for setup steps, shortcuts, and workflow tips.",
		entryDownload: "Download app",
		entryLearnOpen: "Open Learn",
		entryPhraseOne: "Welcome to Cloud, ready to build?",
		entryPhraseTwo: "Open your session and keep the workflow clean.",
		entryPhraseThree: "Select files, manage scripts, save with focus.",
		entryPhraseFour: "Minimal interface. Professional scripting flow.",
	...
	"pt-BR": {
		...
		entryHeroTitle: "Cloud Workspace",
		entryHeroBody: "Conecte sua sessão privada, abra a árvore do projeto e edite scripts em um workspace limpo e profissional.",
		...
		entryConnectBody: "Cole o ID da sessão e o Hidden Secret para abrir o seu workspace privado.",
		...
		entryCtaBody: "Abra o Learn para ver configuração, atalhos e dicas de fluxo.",
		...
		entryPhraseThree: "Selecione arquivos, gerencie scripts e salve com foco.",
		entryPhraseFour: "Interface mínima. Fluxo profissional de scripts.",
