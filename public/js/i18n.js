...
export const TRANSLATIONS = {
	en: {
		...
		entryHeroTitle: "Keep your scripts tidy and your workflow moving.",
		entryHeroBody: "Cloud keeps session access simple, editing focused, and the workspace clean enough for longer building sessions.",
		...
		entryConnectTitle: "Welcome to Cloud",
		entryConnectBody: "Enter your Session ID and Hidden Secret to open your private workspace.",
		...
		entryCtaBody: "Open Learn for the full connection flow, installation notes, and the quick routine for everyday use.",
		entryDownload: "Download app",
		entryLearnOpen: "Open Learn",
		entryPhraseOne: "Welcome to Cloud, ready to build?",
		entryPhraseTwo: "Open your session, then settle into the flow.",
		entryPhraseThree: "Write clean scripts, keep the workspace under control.",
		entryPhraseFour: "Cloud keeps the busy parts quieter so coding feels lighter.",
		learnPageKicker: "Learn",
		learnPageTitle: "Learn Cloud",
		learnPageSubtitle: "A clearer walkthrough for installing Cloud, connecting a session, and keeping your coding flow smooth.",
		...
		learnSidebarQuickTitle: "Before you connect",
		learnSidebarQuickOne: "Install the desktop app if you want the smoothest experience.",
		learnSidebarQuickTwo: "Open the plugin inside your game development environment.",
		learnSidebarQuickThree: "Create a session and keep both credentials nearby.",
		learnSidebarKeysTitle: "Helpful shortcuts",
		learnKeyOne: "Save the active script.",
		learnKeyTwo: "Select multiple scripts.",
		learnKeyThree: "Remove selected scripts or folders.",
		learnKeyFour: "Copy, cut, and paste scripts.",
		...
		learnStepFourBody: "Paste the two values on the start screen and confirm the connection.",
	...
	"pt-BR": {
		...
		entryHeroTitle: "Mantenha seus scripts organizados e o seu fluxo em movimento.",
		entryHeroBody: "Cloud deixa o acesso da sessão simples, a edição focada e o workspace limpo o bastante para sessões mais longas.",
		...
		entryConnectTitle: "Bem-vindo ao Cloud",
		entryConnectBody: "Digite o ID da sessão e o Hidden Secret para abrir o seu workspace privado.",
		...
		entryCtaBody: "Abra Learn para ver o fluxo completo de conexão, notas de instalação e a rotina rápida de uso.",
		entryDownload: "Baixar app",
		entryLearnOpen: "Abrir Learn",
		entryPhraseOne: "Bem-vindo ao Cloud, pronto para programar?",
		entryPhraseTwo: "Abra a sua sessão e entre no fluxo.",
		entryPhraseThree: "Escreva scripts limpos e mantenha o workspace sob controle.",
		entryPhraseFour: "O Cloud deixa a parte corrida mais silenciosa para programar com mais leveza.",
		learnPageKicker: "Aprender",
		learnPageTitle: "Aprender Cloud",
		learnPageSubtitle: "Um guia mais claro para instalar o Cloud, conectar uma sessão e manter o fluxo de programação suave.",
		...
		learnSidebarQuickTitle: "Antes de conectar",
		learnSidebarQuickOne: "Instale o app desktop se quiser a experiência mais suave.",
		learnSidebarQuickTwo: "Abra o plugin dentro do seu ambiente de desenvolvimento de jogos.",
		learnSidebarQuickThree: "Crie uma sessão e deixe as duas credenciais por perto.",
		learnSidebarKeysTitle: "Atalhos úteis",
		learnKeyOne: "Salva o script ativo.",
		learnKeyTwo: "Seleciona vários scripts.",
		learnKeyThree: "Remove scripts ou pastas selecionados.",
		learnKeyFour: "Copia, recorta e cola scripts.",
		...
		learnStepFourBody: "Cole os dois valores na tela inicial e confirme a conexão.",
