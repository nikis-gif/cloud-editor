...
export const TRANSLATIONS = {
	en: {
		...
		outputTitle: "Output",
		outputWaiting: "Waiting for play session logs.",
		outputEmpty: "Run the game with the Cloud plugin connected to mirror prints, warnings, stack traces, and script errors here.",
		outputNoMatches: "No output entries match the current filters.",
		outputAllMessages: "All Messages",
		outputAllContexts: "All Contexts",
		outputErrors: "Errors",
		outputWarnings: "Warnings",
		outputPrints: "Prints",
		outputInfo: "Info",
		outputFilterPlaceholder: "Filter...",
		outputShowTimestamp: "Show timestamp",
		outputShowContext: "Show context",
		outputShowSource: "Show source",
		outputShowPreview: "Show script preview",
		refresh: "Refresh",
		clear: "Clear",
		learnConnectionFlowTitle: "Connection flow",
		learnConnectionOne: "Open the plugin inside your controlled game development environment.",
		learnConnectionTwo: "Create a private session and copy both generated values.",
		learnConnectionThree: "Paste the Session ID and Hidden Secret on the Cloud start screen.",
		learnConnectionFour: "After connecting, Cloud loads the project tree and keeps the workspace available for editing.",
		learnDailyFlowTitle: "Daily workflow",
		learnDailyOne: "Use the Explorer to open scripts and keep folders organized.",
		learnDailyTwo: "Use tabs when jumping between multiple scripts.",
		learnDailyThree: "Use split view when comparing or editing two scripts at the same time.",
		learnDailyFour: "Save often with Ctrl + S and use the footer status to confirm the editor state.",
		learnOutputTitle: "Output mirror",
		learnOutputOne: "Run the game while the Cloud session is active.",
		learnOutputTwo: "Prints, warnings, and runtime errors are mirrored to the Output panel.",
		learnOutputThree: "Errors show the runtime source path and stack details when available.",
		learnOutputFour: "Drag the top edge of Output to resize the panel.",
		learnAllShortcutsTitle: "All shortcuts",
		shortcutSave: "Save the active script.",
		shortcutCloseTab: "Close the active tab.",
		shortcutSwitchTab: "Switch to a tab by position.",
		shortcutCreate: "Create a new item from the selected parent.",
		shortcutDuplicate: "Duplicate selected Explorer items or the active script.",
		shortcutCopy: "Copy selected Explorer items.",
		shortcutCut: "Cut selected Explorer items.",
		shortcutPaste: "Paste copied or cut items into the selected parent.",
		shortcutRangeSelect: "Select a range of scripts in the Explorer.",
		shortcutToggleSelect: "Toggle one item in the current selection.",
		shortcutDelete: "Remove selected scripts or folders.",
		shortcutRename: "Rename the selected item.",
		shortcutFold: "Fold the active script.",
		shortcutUnfold: "Unfold the active script.",
		shortcutZoomIn: "Increase the Cloud UI zoom.",
		shortcutZoomOut: "Decrease the Cloud UI zoom.",
		shortcutZoomReset: "Reset the Cloud UI zoom.",
		shortcutEsc: "Close modals, panels, Learn, search, or create dialogs.",
		learnExplorerActionsTitle: "Explorer actions",
		learnExplorerOne: "Create scripts, local scripts, module scripts, and folders from valid parents.",
		learnExplorerTwo: "Copy, cut, paste, duplicate, rename, and delete directly from the Explorer.",
		learnExplorerThree: "Use multi-select before copy, cut, duplicate, or delete actions.",
		learnEditorBehaviorTitle: "Editor behavior",
		learnEditorOne: "Cloud keeps editor shortcuts separate from Explorer shortcuts when focus is inside code.",
		learnEditorTwo: "Copy and cut text still work normally inside the editor.",
		learnEditorThree: "Explorer copy, cut, paste, and delete run when focus is outside the code editor.",
	...
	"pt-BR": {
		...
		outputTitle: "Output",
		outputWaiting: "Aguardando logs da sessão de jogo.",
		outputEmpty: "Execute o jogo com o plugin Cloud conectado para espelhar prints, avisos, stack traces e erros de scripts aqui.",
		outputNoMatches: "Nenhuma entrada do Output corresponde aos filtros atuais.",
		outputAllMessages: "Todas as mensagens",
		outputAllContexts: "Todos os contextos",
		outputErrors: "Erros",
		outputWarnings: "Avisos",
		outputPrints: "Prints",
		outputInfo: "Info",
		outputFilterPlaceholder: "Filtrar...",
		outputShowTimestamp: "Mostrar timestamp",
		outputShowContext: "Mostrar contexto",
		outputShowSource: "Mostrar fonte",
		outputShowPreview: "Mostrar preview do script",
		refresh: "Atualizar",
		clear: "Limpar",
		learnConnectionFlowTitle: "Fluxo de conexão",
		learnConnectionOne: "Abra o plugin dentro do seu ambiente controlado de desenvolvimento de jogos.",
		learnConnectionTwo: "Crie uma sessão privada e copie os dois valores gerados.",
		learnConnectionThree: "Cole o ID da sessão e o Hidden Secret na tela inicial do Cloud.",
		learnConnectionFour: "Depois de conectar, o Cloud carrega a árvore do projeto e mantém o workspace disponível para edição.",
		learnDailyFlowTitle: "Fluxo diário",
		learnDailyOne: "Use o Explorer para abrir scripts e manter as pastas organizadas.",
		learnDailyTwo: "Use abas para alternar entre vários scripts.",
		learnDailyThree: "Use split view quando precisar comparar ou editar dois scripts ao mesmo tempo.",
		learnDailyFour: "Salve com frequência usando Ctrl + S e use o status do rodapé para confirmar o estado do editor.",
		learnOutputTitle: "Espelho do Output",
		learnOutputOne: "Execute o jogo enquanto a sessão do Cloud estiver ativa.",
		learnOutputTwo: "Prints, avisos e erros em runtime são espelhados no painel Output.",
		learnOutputThree: "Erros mostram o caminho do script em runtime e detalhes da stack quando disponível.",
		learnOutputFour: "Arraste a borda superior do Output para redimensionar o painel.",
		learnAllShortcutsTitle: "Todos os atalhos",
		shortcutSave: "Salva o script ativo.",
		shortcutCloseTab: "Fecha a aba ativa.",
		shortcutSwitchTab: "Alterna para uma aba pela posição.",
		shortcutCreate: "Cria um novo item a partir do pai selecionado.",
		shortcutDuplicate: "Duplica itens selecionados no Explorer ou o script ativo.",
		shortcutCopy: "Copia itens selecionados no Explorer.",
		shortcutCut: "Recorta itens selecionados no Explorer.",
		shortcutPaste: "Cola itens copiados ou recortados dentro do pai selecionado.",
		shortcutRangeSelect: "Seleciona uma sequência de scripts no Explorer.",
		shortcutToggleSelect: "Alterna um item na seleção atual.",
		shortcutDelete: "Remove scripts ou pastas selecionados.",
		shortcutRename: "Renomeia o item selecionado.",
		shortcutFold: "Recolhe o script ativo.",
		shortcutUnfold: "Expande o script ativo.",
		shortcutZoomIn: "Aumenta o zoom da interface do Cloud.",
		shortcutZoomOut: "Diminui o zoom da interface do Cloud.",
		shortcutZoomReset: "Reseta o zoom da interface do Cloud.",
		shortcutEsc: "Fecha modais, painéis, Learn, busca ou diálogos de criação.",
		learnExplorerActionsTitle: "Ações do Explorer",
		learnExplorerOne: "Crie scripts, local scripts, module scripts e pastas em pais válidos.",
		learnExplorerTwo: "Copie, recorte, cole, duplique, renomeie e exclua diretamente pelo Explorer.",
		learnExplorerThree: "Use multisseleção antes de copiar, recortar, duplicar ou excluir.",
		learnEditorBehaviorTitle: "Comportamento do editor",
		learnEditorOne: "O Cloud separa atalhos do editor dos atalhos do Explorer quando o foco está no código.",
		learnEditorTwo: "Copiar e recortar texto continuam funcionando normalmente dentro do editor.",
		learnEditorThree: "Copiar, recortar, colar e excluir do Explorer funcionam quando o foco está fora do editor de código.",
