...
export const TRANSLATIONS = {
	en: {
		...
		entryBrandSubtitle: "Professional scripting workspace",
		entryLearn: "Learn",
		entryPlugin: "Plugin",
		entryHeroBadge: "Private workspace",
		entryHeroTitle: "A cleaner way to open, edit, and ship scripts.",
		entryHeroBody: "Cloud brings the project tree, editor, and file actions together in one modern workspace so you can stay focused from setup to save.",
		...
		entryCtaBody: "Open Learn for setup steps, shortcut tips, and the normal Cloud workflow.",
		...
		learnPageTitle: "Learn the Cloud workflow",
		learnPageSubtitle: "A practical guide for connecting your workspace, understanding the session flow, and using the editor with confidence.",
		learnSidebarTitle: "What happens behind the scenes",
		learnSidebarBody: "Cloud keeps a private session between the app and your development environment, which lets you browse, edit, save, and organize workspace files inside one focused flow.",
		...
		learnHeroTitle: "A clear path from connection to daily work.",
		learnHeroBody: "If this is your first time using Cloud, follow the setup sequence once. After that, the normal routine becomes connect, open the scripts you need, edit, save, and manage the workspace structure from one place.",
		...
		learnRoutineTitle: "A practical daily routine",
		...
		learnToolsTitle: "What you can manage in the workspace",
		...
		project: "Project",
		searchPlaceholder: "Search files, folders, classes, or paths",
		noFileOpen: "No file open",
		filePathEmpty: "Connect to your private workspace and open a script to begin editing.",
		search: "Search",
	...
	"pt-BR": {
		brandSubtitle: "A complete integrated development environment for game scripting.",
		entryBrandSubtitle: "Workspace profissional de scripts",
		entryLearn: "Aprender",
		entryPlugin: "Plugin",
		entryHeroBadge: "Workspace privado",
		entryHeroTitle: "Uma forma mais limpa de abrir, editar e entregar scripts.",
		entryHeroBody: "O Cloud reúne a árvore do projeto, o editor e as ações de arquivo em um único workspace moderno para você continuar focado do setup até o save.",
		...
		entryCtaBody: "Abra o Learn para ver os passos de configuração, dicas de atalhos e o fluxo normal do Cloud.",
		...
		learnPageTitle: "Aprenda o fluxo do Cloud",
		learnPageSubtitle: "Um guia prático para conectar o workspace, entender o fluxo da sessão e usar o editor com segurança.",
		learnSidebarTitle: "O que acontece por trás",
		learnSidebarBody: "O Cloud mantém uma sessão privada entre o app e o seu ambiente de desenvolvimento, permitindo navegar, editar, salvar e organizar os arquivos do workspace dentro de um único fluxo focado.",
		...
		learnHeroTitle: "Um caminho claro da conexão até o trabalho do dia a dia.",
		learnHeroBody: "Se esta é a sua primeira vez no Cloud, siga a sequência de configuração uma vez. Depois disso, a rotina normal vira conectar, abrir os scripts que você precisa, editar, salvar e organizar a estrutura do workspace em um só lugar.",
		...
		learnRoutineTitle: "Uma rotina prática do dia a dia",
		...
		learnToolsTitle: "O que você pode gerenciar no workspace",
