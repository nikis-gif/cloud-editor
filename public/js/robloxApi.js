...
export const SERVICE_NAMES = [
	"Workspace", "Players", "Lighting", "MaterialService", "NetworkClient", "ReplicatedFirst", "ReplicatedStorage", "ServerScriptService", "ServerStorage", "StarterGui", "StarterPack", "StarterPlayer", "Teams", "SoundService", "TextChatService", "CollectionService", "TweenService", "RunService", "UserInputService", "ContextActionService", "Debris", "HttpService", "MarketplaceService", "TeleportService", "DataStoreService", "MemoryStoreService", "MessagingService", "BadgeService", "GroupService", "PhysicsService", "PathfindingService", "ProximityPromptService", "GuiService", "GamepadService", "HapticService", "LocalizationService", "PolicyService", "AnalyticsService", "AvatarEditorService", "AssetService", "InsertService", "ContentProvider", "Selection", "ChangeHistoryService", "ScriptEditorService", "TestService", "TextService", "VoiceChatService", "StarterPlayerScripts", "StarterCharacterScripts", "LocalizationTable", "ScriptContext", "LogService", "Stats", "Teams", "Chat", "VRService", "VirtualInputManager", "GamePassService", "UserService", "MemoryStoreService",
];
