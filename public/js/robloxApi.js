...
export const SERVICE_NAMES = [
	"Workspace", "RunService", "GuiService", "Stats", "TimerService", "CollectionService", "SoundService", "VideoCaptureService", "LogService", "MicroProfilerService", "ContentProvider", "KeyframeSequenceProvider", "AnimationClipProvider", "Chat", "MarketplaceService", "Players", "PointsService", "NotificationService", "ReplicatedFirst", "HttpRbxApiService", "TweenService", "MaterialService", "TextChatService", "TextService", "PermissionsService", "SharedTableRegistry", "StarterPlayer", "StarterPack", "StarterGui", "CoreGui", "LocalizationService", "PolicyService", "TeleportService", "JointsService", "PhysicsService", "BadgeService", "FriendService", "InsertService", "GamePassService", "Debris", "CookiesService", "Selection", "UserInputService", "KeyboardService", "MouseService", "VRService", "ContextActionService", "ScriptService", "AssetService", "TouchInputService", "BrowserService", "CaptureService", "AnalyticsService", "SlimContentProvider", "Packages", "GuidRegistryService", "PublishService", "ChangeHistoryService", "LuaWebService", "ProcessInstancePhysicsService", "ReplicatedStorage", "ServerScriptService", "ServerStorage", "NetworkClient", "StudioService", "PluginGuiService", "ScriptContext", "PathfindingService", "SelectionHighlightManager", "ServiceVisibilityService", "HttpService", "HapticService", "ScriptEditorService", "RemoteDebuggerServer", "DebuggerManager", "PluginDebugService", "PackageService", "Visit", "Lighting", "Teams", "FeatureRestrictionManager", "CommerceService", "RecommendationService", "TestService", "AdService", "SocialService", "ProximityPromptService", "VoiceChatService", "AvatarCreationService", "AvatarEditorService", "GenerationService", "ScriptProfilerService", "HeapProfilerService", "ModerationService", "VideoService", "VersionControlService", "RemoteCommandService", "StudioTestService", "MemStorageService", "StylingService", "DraftsService", "UserService", "DraggerService", "FilteredSelection", "EncodingService", "VirtualInputManager", "ReflectionService", "PlacesService", "UniqueIdLookupService", "PluginManagementService", "InstanceExtensionsService", "Instance", "GroupService", "VisualizationModeService", "MeshContentProvider", "SolidModelContentProvider", "HSRDataContentProvider", "UGCValidationService", "TextBoxService", "GamepadService", "ControllerService", "UIDragDetectorService",
];
